      ...
      <div className="registration-container">
        <div className="registration-form-wrapper">
          <div className="registration-header">
            ...
            <p className="registration-subtitle">Register your institution to join the network and manage life-saving blood and organ resources efficiently.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="registration-form">
            ...
            <div className="form-section">
              ...
              <p className="section-subtitle">Upload your Medical License or Operating Permit issued by the Ministry of Health.</p>
              ...
              <div className="info-box">
                ...
                <p>All documents must be valid and are subject to verification by the Ministry of Health and LifeLink admins. Falsification of documents will lead to permanent de-listing.</p>
              </div>
            </div>

            {/* Submit Button */}
            <button type="submit" className="submit-btn hospital-submit">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="registration-sidebar">
          <div className="sidebar-card hospital-sidebar">
            ...
            <div className="sidebar-badge">
              ...
              <p className="sidebar-impact">By registering, you become part of a real-time ecosystem connecting donors with critical needs.</p>
